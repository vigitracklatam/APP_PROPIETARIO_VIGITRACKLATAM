...
import 'min_tarj_vueltapdf.dart';

class MinTarjetasVuelta extends StatefulWidget {
  MinTarjetasVuelta({super.key});
  ...
  @override
  State<MinTarjetasVuelta> createState() => _nameState();
}

class _nameState extends State<MinTarjetasVuelta> {
  @override
  void initState() {
    _ItemDropdownButton();
    _getFechaActual();
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: SafeArea(
          child: Scaffold(
              appBar: AppBar(
                title: Text("Minutos Tarjetas Vueltas"),
                elevation: 1,
                    ...
                    children: [
                      Expanded(
                        ...
                        child: DropdownButton<String>(
                          ...
                          value: widget.lista_unidades.isNotEmpty
                              ? widget.lista_unidades[widget.position].value
                              : widget._unidad,
                          items: widget.lista_unidades,
                          onChanged: (String? value) {
                            print(
                                'Aca lista de unidades ${widget.lista_unidades}');
                            setState(() {
                    ...
                    children: [
                      Expanded(
                        ...
                        label: const Text(
                          "Buscar",
                          style: TextStyle(
                              fontSize: textBigMedium, color: Colors.white),
                        ),
                      ))
                    ],
                  ),
  ...
  _ItemDropdownButton() async {
    ...
    setState(() {
      listabuses.data!.forEach((element) {
        ...
        widget.lista_unidades.add(DropdownMenuItem<String>(
          child: Row(
