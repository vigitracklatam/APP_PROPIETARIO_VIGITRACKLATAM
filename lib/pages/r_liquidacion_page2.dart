...
class ReporteLiquidacionPage2 extends StatefulWidget {
  ReporteLiquidacionPage2({Key? key});
...
class _LiquidacionPageState extends State<ReporteLiquidacionPage2> {
  String propietario = "";
      ...
      children: [
        Row(
          children: const [
            ...
            _HeaderCell("Frec", width: 35),
            _HeaderCell("Sub.", width: 50),
            _HeaderCell("Baj.", width: 50),
            _HeaderCell("Valor", width: 70),
      ...
      children: [
        Row(
          children: [
            ...
            Container(
              width: 35,
              child: _CellText('${item.LetrRuta}', fontSize: 16, isBold: true),
            ),
            Container(
              width: 35,
              child: _CellText('${item.LetrFrec}', fontSize: 16, isBold: true),
            ),
            Container(
              width: 50,
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              _buildConfirmRow("Frecuencia:", "Frecuencia7"),
    ...
    return Container(
      child: Row(
        children: [
          ...
          Container(width: 35, child: _CellTextTotal('')),
          Container(width: 35, child: _CellTextTotal('')),
          Container(width: 50, child: _CellTextTotal('')),
          Container(width: 50, child: _CellTextTotal('')),
